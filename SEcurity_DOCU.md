...
A02:2021 – Cryptographic Failures: 
    1. Hardcoding password/keys in the code  -->  .env & Pydantic Settings. --> front-end - [x]
...
A05:2021 – Security Misconfiguration: 
    1. use a Security configuratino for redis --> hardening process - [x]
    2. CORS & general configurations for fastAPI app --> The Fix: Whitelist only the specific domains of your frontend applications - [x]
    3. Missing Security Headers: FastAPI does not add security headers (like HSTS or X-Frame-Options) by default. - [x]
        The Fix: Use a library like "secure" or add middleware.
    4. Debug is False in production. - [x]

    5. cookie missconfiguration???

A06:2021 – Vulnerable and Outdated Components
    1. dependency versino management (nodeja & python) - [x]
...
A07:2021 – Identification and Authentication Failures: 
    ...
    3. session token management: aren't properly invalidated during logout or a period of inactivity. invalidated upon logoutb - [x]
...
A08:2021 – Software and Data Integrity Failures: code and infrastructure that does not protect against integrity violations.
    1. Download signed packages from official resources --> hash - [x]
...
A09:2021 – Security Logging and Monitoring Failures: help detect, escalate, and respond to active breaches.
    ...
    2. Must-Log" IAM Events Checklist --> Authentication, Authorization, Token Management, Admin actions and System (startupt/sthudown) -[x]
        # Install: pip install structlog uvicorn[standard]
        import structlog
        import logging
    3. use a logging "middlewwear" (Use structlog for JSON Logs) enhanced formating for future monitoring. -[x]
